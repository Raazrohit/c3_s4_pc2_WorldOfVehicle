public class GasEngine extends IcEngines{

    private String fuelType;
    private String emission;

    public GasEngine(long modelNo, int maxPower, int maxRpm, int displacement, int numberOfCylinders, String fuelType, String emission) {
    ...
    public void display(){
        System.out.println("Specifications of Gas Engine : ");
